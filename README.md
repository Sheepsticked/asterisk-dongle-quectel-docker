# Asterisk + chan_dongle + chan_quectel
...
Docker repository: [sheepsticked/asterisk-dongle-quectel-rpi](https://hub.docker.com/r/sheepsticked/asterisk-dongle-quectel-rpi)
